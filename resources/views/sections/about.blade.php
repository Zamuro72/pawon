    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Selamat Datang di <i class="fa fa-utensils text-primary me-2"></i>Pawon</h1>
                <p class="mb-4">Tempat dan Makanan Terbaik Hanya disini</p>
                <p class="mb-4">Nasi Goreng Ayam Katsu Terbaik di Cikarang langsung coba aja ke lokasi nya</p>
                ...
                <a class="btn btn-primary py-3 px-5 mt-2" href="{{ route('about') }}">Selengkapnya</a>
            </div>
        </div>
    </div>
</div>